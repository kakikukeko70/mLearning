...
urlpatterns = [
    ...
    path('change_folder_name/<int:pk>/', folder.ChangeFolderName.as_view(), name='change_folder_name'),
    ...
    path('change_folder/<int:pk>/', bookmark.ChangeFolderView.as_view(), name='change_folder'),
